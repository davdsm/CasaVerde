                ...
                <div className="dropdown-content">
                    { childNavigationLinks &&
                        childNavigationLinks.map(({ href: childHref, id: childId, text: childText }) => 
                            <Link key={childId} to={childHref} id={childId} className="navigation-link" style={isChildActive && isChildActive[childId] ? { color: "#008D36" } : undefined} onClick={() => onNavigate()} >
