...
const PrivacyPolicy: React.FunctionComponent = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Casa Verde | Política de Privacidade</title>
      </Helmet>
        <div id="privacy-policy">
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    A sua privacidade é importante para nós. É política do Casa Verde respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://acasaverde.pt/">Casa Verde</a>, e outros sites que possuímos e operamos.
                </span>
            </p>
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    Apenas retemos as informações coletadas pelo tempo necessário para fornecer o perdas e roubos, bem como acesso, divulgação, cópia, uso ou modificação não autorizados.
                </span>
            </p>
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas&nbsp;</span>políticas de privacidade<span style={{ color: "rgb(68, 68, 68)"}}>.
                </span>
            </p>
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    <ul>
                        ...
                        <li>
                            <span style={{ color: "rgb(68, 68, 68)"}}>Vários parceiros anunciam em nosso nome e os cookies de
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    ...
                    o Casa Verde oferece no site e com caráter enunciativo, mas não limitativo:
                </span>
            </p>
            <ul>
                <li>
                ...
                <li>
                    <span style={{ color: "rgb(68, 68, 68)"}}>
                        B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, </span><span style={{ color: "rgb(33, 37, 41)"}}></span><span
                ...
                <li>
                    <span style={{ color: "rgb(68, 68, 68)"}}>
                        ...
                        do Casa Verde, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver
            ...
            <p>
                <span style={{ color: "rgb(68, 68, 68)"}}>
                    Esta política é efetiva a partir de&nbsp;1 October 2024 23:12
                </span>
            </p>
        </div>
    </React.Fragment>
